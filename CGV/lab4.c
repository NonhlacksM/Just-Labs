...
void Object2(){ // wireframe polyhedron
...
void Object3(){ //The cone and the cylinder
        glPushMatrix();
        glColor3f(1,0.65,0);
        //glRotatef(90, 0.7071f, 0.7071f, 0);
        glRotatef(48,0,1,0);
        glRotatef(315,1,0,0);
...
void draw() {
    ...
    case 1: // 2D quad shape
        Object1();
    break;
    
    case 2: //wireframe polyhedron
        Object2();
    break;

    case 3: //The cone and the cylinder
        Object3();
    break;
